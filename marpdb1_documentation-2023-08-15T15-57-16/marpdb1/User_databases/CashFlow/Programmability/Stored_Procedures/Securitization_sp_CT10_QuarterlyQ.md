...
[Project](../../../../../index.md) > [marpdb1](../../../../index.md) > [User databases](../../../index.md) > [CashFlow](../../index.md) > Programmability > [Stored Procedures](Stored_Procedures.md) > Securitization.sp_CT10_QuarterlyQ

# ![Stored Procedures](../../../../../Images/StoredProcedure32.png) [Securitization].[sp_CT10_QuarterlyQ]
...
-- =============================================
CREATE PROCEDURE [Securitization].[sp_CT10_QuarterlyQ]
    @PoolID [INT],
    @UserID [NVARCHAR](255)
AS
...
SELECT @ConcentrationTest_ID = 10;
...
BEGIN
    ...
    WHERE pc.Pool_ID = @PoolID
          AND pc.Active = 1
          AND (([BillingFrequency] = 'Quarterly'))
    OPTION (RECOMPILE);
