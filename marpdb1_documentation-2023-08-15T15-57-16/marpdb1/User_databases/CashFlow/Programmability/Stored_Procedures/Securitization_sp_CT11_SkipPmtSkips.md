...
[Project](../../../../../index.md) > [marpdb1](../../../../index.md) > [User databases](../../../index.md) > [CashFlow](../../index.md) > Programmability > [Stored Procedures](Stored_Procedures.md) > Securitization.sp_CT11_SkipPmtSkips

# ![Stored Procedures](../../../../../Images/StoredProcedure32.png) [Securitization].[sp_CT11_SkipPmtSkips]
...
-- =============================================
CREATE PROCEDURE [Securitization].[sp_CT11_SkipPmtSkips]
    @PoolID [INT],
    @UserID [NVARCHAR](255)
AS
...
SELECT @ConcentrationTest_ID = 11;
...
BEGIN
    ...
    WHERE pc.Pool_ID = @PoolID
          AND pc.Active = 1
          AND (([BillingFrequency] = 'Skip Pymt'))
    OPTION (RECOMPILE);
