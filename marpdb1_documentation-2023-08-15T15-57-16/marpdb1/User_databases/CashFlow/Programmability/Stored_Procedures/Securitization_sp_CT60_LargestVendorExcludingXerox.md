...
[Project](../../../../../index.md) > [marpdb1](../../../../index.md) > [User databases](../../../index.md) > [CashFlow](../../index.md) > Programmability > [Stored Procedures](Stored_Procedures.md) > Securitization.sp_CT60_LargestVendorExcludingXerox

# ![Stored Procedures](../../../../../Images/StoredProcedure32.png) [Securitization].[sp_CT60_LargestVendorExcludingXerox]
...
-- =============================================
CREATE PROCEDURE [Securitization].[sp_CT60_LargestVendorExcludingXerox]
	@PoolID [int],
	@UserID [nvarchar](255)
AS
...
SELECT @ConcentrationTest_ID = 60
...
AND pc.Active = 1 
AND [AggregationParentID] <> '020412-0000'
...
AND pc.Active = 1
	AND (
	      (
[AggregationParentID] <> '020412-0000'	      )
) OPTION (RECOMPILE);
WITH Ranks AS (
select [AggregationParentID] as RankField from(
select RTrim([AggregationParentID]) as [AggregationParentID], 
