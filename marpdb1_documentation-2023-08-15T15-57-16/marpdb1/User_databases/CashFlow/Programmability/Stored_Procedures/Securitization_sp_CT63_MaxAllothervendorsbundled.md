...
[Project](../../../../../index.md) > [marpdb1](../../../../index.md) > [User databases](../../../index.md) > [CashFlow](../../index.md) > Programmability > [Stored Procedures](Stored_Procedures.md) > Securitization.sp_CT63_MaxAllothervendorsbundled

# ![Stored Procedures](../../../../../Images/StoredProcedure32.png) [Securitization].[sp_CT63_MaxAllothervendorsbundled]
...
-- =============================================
CREATE PROCEDURE [Securitization].[sp_CT63_MaxAllothervendorsbundled]
	@PoolID [int],
	@UserID [nvarchar](255)
AS
...
SELECT @ConcentrationTest_ID = 63
