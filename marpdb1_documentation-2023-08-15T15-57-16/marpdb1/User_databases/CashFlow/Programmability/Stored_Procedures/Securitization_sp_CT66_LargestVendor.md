...
[Project](../../../../../index.md) > [marpdb1](../../../../index.md) > [User databases](../../../index.md) > [CashFlow](../../index.md) > Programmability > [Stored Procedures](Stored_Procedures.md) > Securitization.sp_CT66_LargestVendor

# ![Stored Procedures](../../../../../Images/StoredProcedure32.png) [Securitization].[sp_CT66_LargestVendor]
...
-- =============================================
CREATE PROCEDURE [Securitization].[sp_CT66_LargestVendor]
	@PoolID [int],
	@UserID [nvarchar](255)
AS
...
SELECT @ConcentrationTest_ID = 66
...
AND pc.Active = 1 
AND ([AggregationParentID] IS NOT NULL AND [AggregationParentID] <> '')
...
AND pc.Active = 1
	AND (
	      (
([AggregationParentID] IS NOT NULL AND [AggregationParentID] <> '')	      )
) OPTION (RECOMPILE);
WITH Ranks AS (
select [AggregationParentID] as RankField from(
select RTrim([AggregationParentID]) as [AggregationParentID], 
