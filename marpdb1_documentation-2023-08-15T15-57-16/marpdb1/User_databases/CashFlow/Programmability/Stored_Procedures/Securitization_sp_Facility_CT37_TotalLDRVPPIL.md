...
[Project](../../../../../index.md) > [marpdb1](../../../../index.md) > [User databases](../../../index.md) > [CashFlow](../../index.md) > Programmability > [Stored Procedures](Stored_Procedures.md) > Securitization.sp_Facility_CT37_TotalLDRVPPIL

# ![Stored Procedures](../../../../../Images/StoredProcedure32.png) [Securitization].[sp_Facility_CT37_TotalLDRVPPIL]
...
-- =============================================
CREATE PROCEDURE [Securitization].[sp_Facility_CT37_TotalLDRVPPIL]
	@FacilityID [int],
	@UserID [nvarchar](255)
AS
...
SELECT @ConcentrationTest_ID = 37
...
WHERE c.Lessor in (SELECT fl.LessorID from Securitization.Facilities f INNER JOIN Securitization.FacilityLessor fl on f.id = fl.Facility_ID where f.id = @FacilityID)
	AND (	      (
([LeveragedIndirectBillCollect] = 'Y') OR ([CollateralCode] = 22) OR ([ProgramTypeID] = 10001 OR [AggregationParentID] = '006000-1000') OR ([ProgramTypeID] = 10001)	      )
) 
